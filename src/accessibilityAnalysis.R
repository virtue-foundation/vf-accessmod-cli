...
fn_speed_friction <- switch(analysis_type,
  isotropic = "amCreateFrictionMap",
  anisotropic = "amCreateSpeedMap"
)
bln_speed_or_friction <- switch(analysis_type,
  isotropic = "friction",
  anisotropic = "speed"
)
...
args_speed_friction <- switch(analysis_type,
  isotropic = list(
    tbl = t_scenarios, mapMerged = "r_merged_lcv",
...
fn_traveltime <- switch(analysis_type,
